...
class Qwen2_5_VLForConditionalGeneration(Qwen2VLForConditionalGeneration):
    ...
    # JJ FIXME: in fact never called. It still works as the config.vision_config.tokens_per_second is infact aligh with the temporal_patch_size 2.
    # def get_rope_index(
    #     self,
    ...
    #                 print('self.config.vision_config.tokens_per_second',self.config.vision_config.tokens_per_second)
