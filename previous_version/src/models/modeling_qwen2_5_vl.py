...
# JJ: not used at all in spatial mllm.
# use the rope_type 'default' having '_compute_default_rope_parameters': 
# https://github.com/huggingface/transformers/blob/8fce0a18de037689384bc4b21da5107127eda539/src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py#L513
...
class Qwen2_5_VL_VGGTForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        ...
        self.merger_config = VGGTEmbeddingMergerConfig(
            ...
            temporal_merge_size=self.config.vision_config.temporal_patch_size, # JJ
        )
