...
# RUN_NAME_APPENDIX="_lvsm_2x8_hpc_01_12view_woEnforceNbr"
# RUN_NAME_APPENDIX="_4x4_hpc_LVSMnvs01_16view_AllTar_sftGatedSdpa_enforceRealNbr"
# RUN_NAME_APPENDIX="_4x4_hpc_LVSMnvs01_12view_AllTar_sftGatedSdpa_enforceRealNbr"
...
NUM_TARGET_VIEWS=6 # actual num of views for loss. We awlays try to provide actual NVS pool with n_in num.
NVS_TARGET_POOL="all" # — 'nvs' (novel only), 'input' (reconstruction sanity check), 'all' (mixed)
